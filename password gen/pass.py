...
class ContactBookGUI:
    ...
    def create_widgets(self):
        self.name_label = tk.Label(self.root, text="Name:", bg='seashell2', fg='gray')
        self.name_label.grid(row=0, column=0, padx=5, pady=5)

        self.name_entry = tk.Entry(self.root)
        self.name_entry.grid(row=0, column=1, padx=5, pady=5)

        self.phone_label = tk.Label(self.root, text="Phone Number:", bg='seashell2', fg='gray')
        self.phone_label.grid(row=1, column=0, padx=5, pady=5)

        self.phone_entry = tk.Entry(self.root)
        self.phone_entry.grid(row=1, column=1, padx=5, pady=5)

        self.email_label = tk.Label(self.root, text="Email:", bg='seashell2', fg='gray')
        ...
        self.display_button = tk.Button(self.root, text="Display Contacts", command=self.display_contacts, bg='orange', fg='white')
